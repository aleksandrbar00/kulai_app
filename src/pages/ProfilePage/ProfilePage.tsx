...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <Box p={6} maxW="container.md" mx="auto">
      <Heading mb={6} size="xl" textAlign="center" color={colors.text.primary}>
        Ваш профиль
      </Heading>
      ...
      <Card maxW="md" w="full" mx="auto">
        <Box p={6}>
          <VStack gap="4" alignItems="stretch">
            ...
            <Box height="1px" bg={colors.border.normal} w="full" />
            ...
            <Box pt={4}>
              <Button onClick={handleLogout} variant="danger" w="full">
                Выйти
              </Button>
            </Box>
          </VStack>
