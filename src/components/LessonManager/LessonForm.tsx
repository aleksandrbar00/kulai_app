    ...
    <>
      ...
      <Box mb={4}>
        ...
        <Box mb={3}>
          ...
          <Box display="flex" flexWrap="wrap" gap={2}>
            {timeOptions.map((option) => (
              <Button
                key={option.value}
                size="sm"
                variant={lesson.totalDuration === option.value && !showCustomInput ? "solid" : "subtle"}
            ...
            <Button
              size="sm"
              variant={showCustomInput ? "solid" : "subtle"}
              colorScheme="blue"
          ...
          {showCustomInput && (
            <Box mt={3}>
              <Text fontSize="sm" mb={1}>Custom Duration (seconds)</Text>
              <Input
                type="number"
